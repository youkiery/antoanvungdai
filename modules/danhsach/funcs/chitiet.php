...
$sql = "select b.ten, b.id as idthucung, b.micro, b.idgiong, b.idchu, b.hinhanh, c.first_name as tenchu, e.diachi, e.dienthoai, d.ten as tenphuong from ". PREFIX ."_tiemphong_thucung b inner join ". PREFIX ."_users c on b.idchu = c.id inner join ". PREFIX ."_users_info e on c.userid = e.userid inner join ". PREFIX ."_quanly_danhmuc_phuong d on e.phuong = d.id where b.id = $id";
