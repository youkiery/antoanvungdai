    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group row matkhau">
          ...
          <div class="col-xs-16"> <input type="text" class="form-control" id="tendangnhap" placeholder="Tên đăng nhập">
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-xs-6"> <label> <input name="phanquyen" type="radio" value="0" onchange="phanquyen()"> Thành
              viên </label> </div>
          <div class="col-xs-6"> <label> <input name="phanquyen" type="radio" value="1" onchange="phanquyen()"> Nhân
              viên </label> </div>
          <div class="col-xs-6"> <label> <input name="phanquyen" type="radio" value="2" onchange="phanquyen()"> Quản lý
            </label> </div>
        </div>
