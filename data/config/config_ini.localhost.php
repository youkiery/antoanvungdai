...
$sys_info['server_headers'] = ['server' => 'Apache/2.4.52 (Win64) OpenSSL/1.1.1m PHP/7.4.27','x-powered-by' => 'PHP/7.4.27','x-is-http' => '1','content-length' => '0','content-type' => 'text/html; charset=UTF-8'];
